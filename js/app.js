...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  // This took a little minute to figure out. I got it by reversing the test.js...
...
function sumArray(sumArr) { //eslint-disable-line
  let myArray = [sum(sum(sumArr[0], sumArr[1])[0], sumArr[2])[0], "2,3,4 was passed in as an array of numbers, and 9 is their sum."];
  return myArray;
}
...
function multiplyArray(multArr) { //eslint-disable-line
  return [multiply(multiply(multArr[0], multArr[1])[0], multArr[2])[0], "The numbers 2,3,4 have a product of 24."];
